<%@ Page Title="" Language="C#" MasterPageFile="~/Invoice_Module.Master" AutoEventWireup="true" CodeBehind="EditProductRate.aspx.cs" Inherits="Invoice_Module.EditProductRate" %>
...
<asp:Content ID="Content8" runat="server" contentplaceholderid="ContentPlaceHolder2">
        ...
        <div class="addButtonDiv">
            <asp:Button ID="UpdateProductRateItems" runat="server" Text="Update" Width="80px" CssClass="btnSave" OnClick="UpdateProductRateItems_Click"/>
